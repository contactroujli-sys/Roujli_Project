                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('\$${p.price.toStringAsFixed(0)}', style: const TextStyle(color: goldColor, fontSize: 18, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ),
                      Container(
          ...
          child: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text('\$${s.price.toStringAsFixed(0)}', style: const TextStyle(color: goldColor, fontSize: 16, fontWeight: FontWeight.bold)),
